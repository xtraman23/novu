...
/**
 * Builds the two separate text artifacts the dispatcher wants kept apart
 * (FR-800): the FULL verbatim transcript, and the EXTRACTED INFO only. Pure
 * string builders so they are unit-tested without a device.
 */
object CallArchive {
